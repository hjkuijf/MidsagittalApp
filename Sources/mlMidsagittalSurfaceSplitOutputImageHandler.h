...
//! The MidsagittalSurfaceSplitOutputImageHandler handles the page calculation of an output image of MidsagittalSurfaceSplit.
...
class MidsagittalSurfaceSplitOutputImageHandler : public TypedCalculateOutputImageHandler<MidsagittalSurfaceSplitOutputImageHandler,
    /* numInputs = */ 1,
    /* MLVariableType0 = */ ScalarTypes>
{
  ...
  public:
    MidsagittalSurfaceSplitOutputImageHandler( const Parameters& parameters );
